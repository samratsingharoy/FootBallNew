...
const initData = [
  {
    image: "/public/images/homepage/init/init1.jpeg",
  ...
  {
    image: "/public/images/homepage/init/init2.jpeg",
  ...
  {
    image: "/public/images/homepage/init/init3.jpeg",
  ...
  return (
    <div className={styles.container}>
      <div className={styles.headerContainer}>
        <h4 className={styles.header}>Initiatives</h4>
      </div>

      <Link>
        <div className={styles.linkContainer}>
          <p className={styles.linkText}>View all Initiatives</p>
